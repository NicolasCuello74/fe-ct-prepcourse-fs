...
function numeroMasGrande(arrayOfNums) {
   ...
   // for(var i = 1; i < arrayOfNums.lenght; i++){
...
function cuentoElementos(array) {
   ...
   // Tu código:
   // let contador = 0;
   // for ( let i=0; i < array.lenght; i++){ if (array[i]>18){contador++}} return contador;

   let cantidadArreglos = 0;

   array.forEach(numero => {
      if (numero > 18) cantidadArreglos = cantidadArreglos+ 1;
   });
   return cantidadArreglos;
}
...
function todosIguales(array) {
   ...
   //    if (actual === array[i]) actual = array[i]
   //    else return false;
   // }
   // return true;
...
function mesesDelAño(array) {
   ...
   // Tu código:eturn "No se encontraron los meses pedidos"
   let mesesRequeridos = [];
   for(let i =0; i<array.length;i++){
